...
public:
    ...
    struct Header {
        ...
        double pose_send_timestamp;
        double pose_recv_timestamp;
        double frame_send_timestamp;
    ...
    QUASARReceiver(QuadSet& quadSet, uint maxLayers, const std::string& videoURL, const std::string& proxiesURL, GLFWwindow* window);
